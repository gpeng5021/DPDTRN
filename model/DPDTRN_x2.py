...
class _Usmnet(nn.Module):
    def __init__(self, scale=2, in_channels=64, out_channels=64, nf=64, nb_Usm_module=1, gc=32):
        super(_Usmnet, self).__init__()

        self.Usm_upconv2x = nn.ConvTranspose2d(in_channels=64, out_channels=64, kernel_size=4, stride=2, padding=1,
                                               bias=False)
...
class Usmsrn(nn.Module):
    def __init__(self, in_c=1, out_c=1, scale=2):
